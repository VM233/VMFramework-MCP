...
namespace VMFramework.MCP.Editor
{
    ...
    public sealed class VMFrameworkLogicTickControlTool : IMCPPersistentProjectTool
    {
        ...
        private static MCPProjectToolJobStep AdvanceStep(
            ...
            IReadOnlyDictionary<string, object> state)
        {
            ...
            {
                return MCPProjectToolJobStep.Complete(BuildResult(
        ...
        private static MCPProjectToolJobStep WaitStep(
            IReadOnlyDictionary<string, object> args,
            IReadOnlyDictionary<string, object> state)
        {
            ILogicTickManager manager = GetManager();
            ...
            {
                throw new MCPProjectToolException("logic_tick_wait_timeout",
        ...
        private static ILogicTickManager GetManager()
        {
            ...
            if (manager == null)
            {
                throw new MCPProjectToolException("logic_tick_manager_unavailable",
