...
{
    [Serializable]
    internal sealed class VMFrameworkMcpProjectConfiguration
    {
        internal const string ConfigPath = "ProjectSettings/VMFrameworkMCPSettings.json";
        ...
        internal static VMFrameworkMcpProjectConfiguration Load()
        {
